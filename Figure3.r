...
workdir <- "."
#datafile <- file.path(workdir,"Figure_o_!o.csv")
#datafile <- file.path(workdir,"Figure_t_!t.csv")
datafile <- file.path(workdir,"Figure_combination.csv")
...
#pdf(file.path(workdir,"Figure_o_!o.pdf"),  onefile=FALSE, width=16, height=7)
#pdf(file.path(workdir,"Figure_t_!t.pdf"),  onefile=FALSE, width=16, height=7)
pdf(file.path(workdir,"Figure_combination.pdf"),  onefile=FALSE, width=16, height=7)
...
forestplot(labeltext=tabletext, 
          ...
          #title ="Five-year risk of incident pancreatic cancer in patients with type 2 diabetes, with and without obesity \n(Comparison between propensity-score matched groups)", 
         ...
         title ="Five-year risk of incident pancreatic cancer in patients with type 2 diabetes\n(Comparison between propensity-score matched cohorts: GLP-1RA combination therapy vs monotherapy)", 
